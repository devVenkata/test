  ...
  return (
    <div className="min-h-[calc(100vh-73px)]">
      ...
      <div className="bg-gradient-to-br from-indigo-600 via-indigo-500 to-purple-500">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-3 text-center">
          <h1 className="text-3xl md:text-5xl font-bold text-white mb-4 md:mb-6">
            Find Your Perfect PG Accommodation
          </h1>
          <p className="text-base md:text-lg text-white/90 mb-8 md:mb-3 max-w-2xl mx-auto">
            ...
            <div className="bg-white p-2 rounded-2xl shadow-lg flex flex-col md:flex-row gap-2">
              <div className="flex-1 relative">
                ...
                <input
                  ...
                  className="w-full px-4 py-2 pl-12 rounded-xl bg-gray-50 border-0
              ...
              <button
                ...
                className="md:w-auto w-full px-8 py-2 bg-indigo-600 text-white font-medium
      ...
      {/* Main Content */}
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-2 py-8 md:py-4">
